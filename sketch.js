...
function draw() {
  ...
  if (i == 5) {
    ...
    //image(light, -65-width/2, -8-height / 6 *5, width+139, height+193);
    image(fog, xpos, ypos - speed + 380, width + 410, height + 83);
    image(fog, xpos, ypos - speed + 450, width + 410, height + 83);
    ypos = -83 - (height / 6) * 5;
    speed += 3.8;
    ssi += 1;
    if ((ssi - (ssi % 2)) / 2 == 1) {
...
function keyPressed() {
  if (key == ENTER) {
    if (ah > 0 && ah < 75) {
      ...
      i = 5;
      si = 5;
      image(bglight, xpos, ypos - speed + 400, width + 410, height + 83);
      fill(0, 0, 0, 0);
    }
    //print(i);
  }
